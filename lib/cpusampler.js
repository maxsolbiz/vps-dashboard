...
// {procs: [...]+null when cold, pct: last valid Map, fresh: bool}
function latest() {
  if (!curr) return { procs: null, pct: new Map(), fresh: false };
  return { procs: curr.procs, pct: lastValid, fresh: lastValid.size > 0 };
}
